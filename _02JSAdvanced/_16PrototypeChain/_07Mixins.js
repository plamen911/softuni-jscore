// https://judge.softuni.bg/Contests/Compete/Index/341#6
'use strict';
    ...
    class Laptop extends Computer {
        ...
        set battery(value) {
            if (!(value instanceof Battery)) {
                throw new TypeError('Value not an instance of Battery');
            }
            this._battery = value;
        }
    }
    ...
    class Desktop extends Computer {
        ...
        set keyboard(value) {
            if (!(value instanceof Keyboard)) {
                throw new TypeError('Value not an instance of Keyboard');
            }
        ...
        set monitor(value) {
            if (!(value instanceof Monitor)) {
                throw new TypeError('Value not an instance of Monitor');
            }
            this._monitor = value;
        }
    }
